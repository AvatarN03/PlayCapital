...
const CreateBlog = () => {
    ...
    return (
        <main className='min-h-1.5 w-full mx-auto max-w-7xl'>
            ...
            <div className="h-full w-full px-4 my-16">
                <form onSubmit={handlePost}>
                    <label htmlFor="title" className="text-4xl block">Title</label>
                    <input
                        type="text"
                        name="title"
                        id="title"
                    ...
                    />
                    <label htmlFor="desc" className="text-2xl block ">Description</label>
                    <textarea
                        name="desc"
                        id="desc"
                        rows={5}
