      ...
      <div className='flex justify-between items-center'>
        {Object.keys(auth).length ? ( 
          <div className='mx-8 border-white border-2 rounded-full relative cursor-pointer drop-shadow-lg ' onClick={() => setProfile(prev => !prev)}>
            ...
            <Link to={'/authorization'} className='text-xs sm:text-base mx-5 block bg-neutral-100 px-2 py-[5px] sm:px-3 md:px-5 rounded-lg'>
            ...
            <Link to={'/about'} className='text-xs sm:text-base mx-5 block bg-neutral-100 px-2 py-[5px] sm:px-3 md:px-5 rounded-lg'>
              About
            </Link>
