...
function IncomeBracket() {
  ...
  <div className="mx-auto w-[90%] bg-[#94cfd8] text-neutral-800 rounded-md p-4 space-y-4">
    <p>
      <span className="text-[#632792] font-bold tracking-wide text-base sm:text-xl">Objective:</span><br />
    ...
    <p>
      <span className="text-[#632792] font-bold tracking-wide text-base sm:text-xl">Turn Options:</span><br />
      - <span className="font-bold text-sm sm:text-base">Borrow:</span> Take a loan to increase your cash flow, but remember, borrowed money incurs interest, which will reduce your capital over time.<br />
      - <span className="font-bold text-sm sm:text-base">Purchase:</span> Buy properties, stocks, or other assets. These assets can grow your capital through appreciation or rental income.<br />
      - <span className="font-bold text-sm sm:text-base">Pass:</span> Skip a turn without borrowing or purchasing. Sometimes holding off is the best move to avoid debt or manage risk.
    </p>

    <p>
      <span className="text-[#632792] font-bold tracking-wide text-base sm:text-xl">Winning:</span> The game ends when a set number of turns is completed or when all assets have been acquired. The player with the highest net worth wins.
    </p>
