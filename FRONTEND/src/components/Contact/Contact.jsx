  ...
  return (
   <section className='max-w-7xl mx-auto mt-32 h-screen w-full relative' id={id}>
    ...
    <div className="flex justify-center items-center w-[90%] h-[98%] mx-auto relative">
        ...
        <h1 className='grid-headtext text-white font-semibold tracking-widest'>Contact Us</h1>


        <p className="text-sm sm:text-lg text-slate-300 tracking-wider mt-3 ">Feel free to Feedback Us. Your Feedback is valuable to Us, Thankyou!!</p>
                    <form ref={form} className='flex flex-col space-y-7 mt-12' onSubmit={sendEmail}>
                        ...
                        <button className={`${loading? "bg-purple-200": "bg-[#BF4C8B]" } px-5 py-2 min-h-12 rounded-lg  flex justify-center items-center text-lg text-white gap-3`} type='submit' >
