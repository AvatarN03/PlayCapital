  ...
  return (
    <>
      ...
      >
        ...
        <h1 className='text-2xl md:text-3xl lg:text-4xl text-center text-slate-200 font-light my-2 sm:my-5 tracking-wide'>Our Team</h1>
        <p className='text-neutral-300 text-base my-5 sm:text-xl  font-extralight tracking-wide max-w-5xl mx-2 sm:mx-auto text-center'>Our diverse team consists of four dedicated individuals: two boys and two girls, each bringing their unique strengths and perspectives. Together, we collaborate to combine creativity, technical expertise, and problem-solving skills to drive innovation and success in our projects.</p>
            ...
            memberNames.map(member => (
              <div className="relative m-4 group translate-y-0 lg:even:-translate-y-1/4 lg:odd:translate-y-1/4">
                ...
                <div className="sm:hidden -mt-8 z-20 min-h-[300px]  bg-[#8f4bc4f3] sm:group-hover:-right-full    sm:group-hover:overflow-visible  bg-opacity-70  transition-opacity duration-300 ease-in-out flex flex-col justify-between md:justify-start items-center sm:items-end p-4 rounded-xl   my-3 group-hover:z-[500px]">
                  {/* Name */}
                  <h2 className="text-neutral-100 text-2xl font-semibold tracking-wider border-b-2 mb-2">{member.name}</h2>
